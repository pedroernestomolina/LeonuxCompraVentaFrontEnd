...
namespace ModInventario.Maestros.Conceptos
{
    ...
    public class GestionLista
    {
        ...
        private List<OOB.LibInventario.Concepto.Ficha> lLista;
        private BindingList<OOB.LibInventario.Concepto.Ficha> blLista;
        ...
        public GestionLista()
        {
            ...
            lLista = new List<OOB.LibInventario.Concepto.Ficha>();
            blLista = new BindingList<OOB.LibInventario.Concepto.Ficha>(lLista);
        ...
        {
            var it = (OOB.LibInventario.Concepto.Ficha)bsLista.Current;
            if (it != null)
            {
