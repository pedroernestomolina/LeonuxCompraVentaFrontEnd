namespace ModInventario.Maestros.EmpaqueMedidas
{
    partial class AgregarEditarFrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.TB_DECIMALES = new LibControles.NumeroEntero();
            ...
            this.BT_GUARDAR.Image = global::ModInventario.Properties.Resources.bt_guardar__2_;
            ...
            // panel5
            // 
            this.panel5.Controls.Add(this.TB_DECIMALES);
            ...
            // TB_DECIMALES
            // 
            this.TB_DECIMALES.BackColor = System.Drawing.Color.Yellow;
            this.TB_DECIMALES.Dock = System.Windows.Forms.DockStyle.Left;
            this.TB_DECIMALES.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.TB_DECIMALES.Location = new System.Drawing.Point(2, 2);
            this.TB_DECIMALES.MaxLength = 2;
            this.TB_DECIMALES.Name = "TB_DECIMALES";
            this.TB_DECIMALES.Size = new System.Drawing.Size(57, 22);
            this.TB_DECIMALES.TabIndex = 0;
            this.TB_DECIMALES.Text = "0";
            this.TB_DECIMALES.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
            this.TB_DECIMALES.TextChanged += new System.EventHandler(this.TB_DECIMALES_TextChanged);
            this.TB_DECIMALES.KeyDown += new System.Windows.Forms.KeyEventHandler(this.TB_KeyDown);
            // 
            // panel10
            // 
            ...
            // panel11
            // 
            this.panel11.Controls.Add(this.TB_NOMBRE);
        ...
        private LibControles.NumeroEntero TB_DECIMALES;
    }
}