...
namespace ModCompra.Proveedor.AgregarEditar.Editar
{
    ...
    public class Gestion : IGestion
    {
        ...
        private string _autoProvEditar; 
        ...
        public bool CargarData()
        {
            ...
            var r03 = Sistema.MyData.Proveedor_GetFicha(_autoProvEditar);
            ...
            _data.cargarFicha(r03.Entidad);
            _data.setEstado(_lstEstado.FirstOrDefault(f => f.auto == r03.Entidad.identidad.autoEstado));
            _data.setGrupo(_lstGrupo.FirstOrDefault(f => f.auto == r03.Entidad.identidad.autoGrupo));
            if (r03.Entidad.identidad.modoDenominacionFiscal == OOB.LibCompra.Proveedor.Enumerados.EnumDenominacionFiscal.Contribuyente)
                _data.setDenFiscal(_lstDenFiscal.FirstOrDefault(f => f.auto == "0000000001"));
            else
                _data.setDenFiscal(_lstDenFiscal.FirstOrDefault(f => f.auto == "0000000002"));
        ...
        private bool GuardarFicha()
        {
            ...
            var dataOOB = new OOB.LibCompra.Proveedor.Editar.Ficha()
            {
                autoPrv= _autoProvEditar,
                ciRif = _data.CiRif,
                codigo = _data.Codigo,
