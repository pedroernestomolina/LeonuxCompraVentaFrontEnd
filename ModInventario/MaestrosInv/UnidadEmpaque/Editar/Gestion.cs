...
namespace ModInventario.MaestrosInv.UnidadEmpaque.Editar
{
    ...
    public class Gestion: IAgregarEditar
    {
        ...
        public string Titulo { get { return "Editar Item: EMPAQUE-MEDIDA"; } }
        ...
        {
            var r01 = Sistema.MyData.EmpaqueMedida_GetFicha(_idItemEditar);
