...
namespace DataProvInventario.InfraEstructura
{
    ...
    public interface IConcepto
    {
        ...
        OOB.ResultadoLista<OOB.LibInventario.Concepto.Ficha> Concepto_GetLista();
        OOB.ResultadoEntidad<OOB.LibInventario.Concepto.Ficha> Concepto_GetFicha(string auto);
