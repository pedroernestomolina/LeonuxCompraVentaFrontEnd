            ...
            if (_cnf.ValidarIsOk())
            {
                ...
                if (msg == DialogResult.Yes) 
                {
                    var ficha = new OOB.Configuracion.Actualizar.Ficha()
                    {
                        ...
                        idFacturaSerie = _cnf.SerieFactura.Auto,
                        ...
                        idNotaCreditoSerie = _cnf.SerieNtCredito.Auto,
                        idNotaDebitoSerie = _cnf.SerieNtDebito.Auto,
                        idNotaEntregaSerie = _cnf.SerieNtEntrega.Auto,
