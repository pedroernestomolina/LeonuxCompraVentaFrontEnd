...
namespace PosOnLine.Helpers.Imprimir.Tickera80
{
    ...
    public class Documento : IDocumento
    {
        ...
        {
            _tick = new Ticket();
            _tick.setModo(Ticket.EnumModoTicket.Modo58mm);
        }
        ...
        private void Imprimir()
        {
            ...
            var stot = Math.Round(_ds.encabezado.SubTotal, 0, MidpointRounding.AwayFromZero);
            var sbtot = Math.Round(_ds.encabezado.SubTotal, 0, MidpointRounding.AwayFromZero);
